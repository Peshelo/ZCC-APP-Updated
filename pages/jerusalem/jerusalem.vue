...
<div v-if="showCenter" class="flex flex-row justify-between items-center">
  ...
  methods:{
    async getRegion() {
        ...
        this.loading = true;
       const URL= "http://localhost:8080/jerusalem";
      ...
      async getCenters(id) {
        ...
        this.loading = true;
       const URL= "http://localhost:8080/regions/get{id}?id="+id;
        // const token = localStorage.token;
        // console.log('Token is string: ' + isString(token))
        // console.log(token);
        await axios.get(URL, {
      ...
      async getGreaters(id) {
        ...
        this.loading = true;
       const URL= "http://localhost:8080/centers/get"+id;
        // const token = localStorage.token;
        // console.log('Token is string: ' + isString(token))
        // console.log(token);
        await axios.get(URL, {
      ...
      async getTabheris(id) {
        ...
        this.loading = true;
       const URL= "http://localhost:8080/nyikas/get/"+id;
        // const token = localStorage.token;
        // console.log('Token is string: ' + isString(token))
        // console.log(token);
        await axios.get(URL, {
  ...
  this.loading = true;
  try{
   await axios.post('http://localhost:8080/regions/add',{
   name:this.region,
   },{
