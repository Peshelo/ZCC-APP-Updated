    ...
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        <div class="sm:flex-auto">
          <h1 class="text-xl font-semibold text-gray-900">Greater View</h1>
...
<div class="flex flex-row justify-between items-region my-2 px-2">
    ...
    methods:{
      async getGreater() {
          ...
          this.loading = true;
         const URL= "http://3.10.190.157:7635/greaters";
    ...
    this.loading = true;
    try{
     await axios.post('http://3.10.190.157:7635/greaters/add?greaterId='+ this.greaterId,
     {
     name:this.center,
     },{
