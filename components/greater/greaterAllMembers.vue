...
// import tabheriAddMember from './tabheriAddMember.vue'
  ...
  methods:{
    async getNyikas() {
        ...
        this.loading = true;
        const URL= `http://3.10.190.157:7635/greaters/get{id}?id=${this.id}`;
    ...
    async handleSubmit(){
      ...
      // Your code for handling the form submission
          ...
          const URL = `http://3.10.190.157:7635/greater/create/committeeMembers?userId=${this.currentMember.id}&position=${this.currentPosition}&greaterId=${this.id}`;
      try{
 ...
 async makeAdmin(memberId){
      ...
      // Your code for handling the form submission
          ...
          const URL = `http://3.10.190.157:7635/admin/create?UserId=${memberId}&scopeId=${this.currentNyika}&scope=NYIKA`;
      try{
       await axios.post(URL,
       {
        headers: 
   ...
   downloadCSV(csv, filename) {
    ...
    async getMembers() {
      ...
      async getCommittee() {
        ...
        this.loading = true;
        const URL= `http://3.10.190.157:7635/greaters/${this.id}/members`;
