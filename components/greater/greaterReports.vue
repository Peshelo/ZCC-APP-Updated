<template>
    <div>
      ...
      <div class="flex flex-row bg-white rounded-md border p-2 justify-between items-center">
        <div class="p-2 w-fit rounded-md">
          <button class="w-fit p-2 px-4 text-white bg-green-400 shadow-md rounded-md border">
            Collections
          </button>
      ...
      <!-- Table -->
      <div class="bg-white border border-gray-300 py-1 rounded-md my-4">
            ...
            <table v-else class="min-w-full my-4">
              <thead class="bg-white">
                <tr>
                  ...
                  <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">ZAR</th>
