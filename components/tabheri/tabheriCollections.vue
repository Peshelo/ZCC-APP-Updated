<template>
    <div>
      ...
      <div class="flex flex-row justify-between items-center">
        ...
        <NuxtLink to="../financials/addNewCollection" class="w-fit p-2 px-4 rounded-md text-white bg-green-400">
            Add New
          </NuxtLink>
      </div>
      ...
      <div class="bg-white border border-gray-300 rounded-md my-4">
        <div class="flex flex-row justify-between items-center my-2 mb-4 px-2">
