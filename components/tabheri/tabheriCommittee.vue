<template>
    <div>
      ...
      <h1 class="text-2xl font-bold mb-4">{{tabheri.name}} Tabheri Committee Members</h1>
  ...
  methods:{
    ...
    async handleSubmit(){
      ...
      // Your code for handling the form submission
          ...
          const URL = `http://localhost:8080/taberis/makeCommittee?userId=${this.currentMember.id}&position=${this.currentPosition}&taberiId=${this.id}`;
      try{
