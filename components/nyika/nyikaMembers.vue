  ...
  methods:{
    ...
    async handleSubmit(){
      ...
      // Your code for handling the form submission
        ...
        //   const URL = 'http://localhost:8080/taberis/makeCommittee?userId='+this.currentMember.id+'&position='+ this.currentPosition +'&taberiId='+localStorage.scopedId;
  ...
  console.log("Error:",err.message)
   ...
   downloadCSV(csv, filename) {
    ...
    async getTabheri() {
      ...
      this.loading = true;
      try{
       await axios.delete(`http://localhost:8080/members/delete/${id}`,{
       },{
